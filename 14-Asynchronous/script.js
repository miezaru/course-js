...
get3Countries('portugal', 'ukraine', 'poland');

//~ Other promise combinators: race, allSettled and any

// Promise.race - who winning the race
(async function () {
...
Promise.race([getJSON(`https://restcountries.com/v3.1/name/tanzania`), timeout(5)]).then(res =>
  console.log(res[0]).catch(err => console.error(err))
);
